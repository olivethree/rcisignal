...
#> ℹ Wrote stimuli to
#>   /tmp/RtmpHJfT4a/rcisignal_sim_21da60ae9dc4/rcisignal_sim_briefrc_stimuli.Rdata
#>   (session tempdir).
#> ℹ Wrote base face to
#>   /tmp/RtmpHJfT4a/rcisignal_sim_21da60ae9dc4/rcisignal_sim_briefrc_base_face.png
#>   (session tempdir).
...
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■    96% | ETA:  7s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■    98% | ETA:  4s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% | ETA:  0s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% | ETA:  0s
#> ℹ Wrote stimuli to
#>   /tmp/RtmpHJfT4a/rcisignal_sim_21da135d849e/rcisignal_sim_briefrc_stimuli.Rdata
#>   (session tempdir).
#> ℹ Wrote base face to
#>   /tmp/RtmpHJfT4a/rcisignal_sim_21da135d849e/rcisignal_sim_briefrc_base_face.png
#>   (session tempdir).
#>   Pass `rdata_dir` to persist across R sessions, or hand `$stimuli` to
#>   downstream consumers.
