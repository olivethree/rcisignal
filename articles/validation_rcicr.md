...
#> ℹ Wrote stimuli to
#>   /tmp/Rtmpj1vBEc/rcisignal_sim_20f937ca8862/rcisignal_sim_briefrc_stimuli.Rdata
#>   (session tempdir).
#> ℹ Wrote base face to
#>   /tmp/Rtmpj1vBEc/rcisignal_sim_20f937ca8862/rcisignal_sim_briefrc_base_face.png
#>   (session tempdir).
...
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■             67% | ETA:  1m
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■             68% | ETA: 48s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■            70% | ETA: 45s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■           72% | ETA: 42s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■           74% | ETA: 40s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■          76% | ETA: 37s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■          78% | ETA: 34s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■         80% | ETA: 31s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■        82% | ETA: 28s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■        84% | ETA: 25s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■■       86% | ETA: 22s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■■       88% | ETA: 19s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■■■      90% | ETA: 15s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■     92% | ETA: 13s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■     94% | ETA:  9s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■    96% | ETA:  6s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■    98% | ETA:  3s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% | ETA:  0s
#> ℹ Wrote stimuli to
#>   /tmp/Rtmpj1vBEc/rcisignal_sim_20f92121233a/rcisignal_sim_briefrc_stimuli.Rdata
#>   (session tempdir).
#> ℹ Wrote base face to
#>   /tmp/Rtmpj1vBEc/rcisignal_sim_20f92121233a/rcisignal_sim_briefrc_base_face.png
#>   (session tempdir).
#>   Pass `rdata_dir` to persist across R sessions, or hand `$stimuli` to
#>   downstream consumers.
