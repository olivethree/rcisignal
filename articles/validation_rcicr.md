...
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■              63% | ETA: 49s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■             66% | ETA: 46s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■             68% | ETA: 43s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■            70% | ETA: 40s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■           72% | ETA: 37s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■           75% | ETA: 33s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■          77% | ETA: 30s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■         79% | ETA: 27s
...
#> ℹ Wrote stimuli to
#>   /tmp/Rtmpg3jvVA/rcisignal_sim_20d55c6b0001/rcisignal_sim_briefrc_stimuli.Rdata
#>   (session tempdir).
#> ℹ Wrote base face to
#>   /tmp/Rtmpg3jvVA/rcisignal_sim_20d55c6b0001/rcisignal_sim_briefrc_base_face.png
#>   (session tempdir).
...
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■          77% | ETA: 33s
...
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% | ETA:  0s
#> ℹ Wrote stimuli to
#>   /tmp/Rtmpg3jvVA/rcisignal_sim_20d55611deec/rcisignal_sim_briefrc_stimuli.Rdata
#>   (session tempdir).
#> ℹ Wrote base face to
#>   /tmp/Rtmpg3jvVA/rcisignal_sim_20d55611deec/rcisignal_sim_briefrc_base_face.png
#>   (session tempdir).
#>   Pass `rdata_dir` to persist across R sessions, or hand `$stimuli` to
#>   downstream consumers.
