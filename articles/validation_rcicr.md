...
#> ℹ Wrote stimuli to
#>   /tmp/RtmpAljdll/rcisignal_sim_20be48ca8635/rcisignal_sim_briefrc_stimuli.Rdata
#>   (session tempdir).
#> ℹ Wrote base face to
#>   /tmp/RtmpAljdll/rcisignal_sim_20be48ca8635/rcisignal_sim_briefrc_base_face.png
#>   (session tempdir).
...
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% | ETA:  0s
#> ℹ Wrote stimuli to
#>   /tmp/RtmpAljdll/rcisignal_sim_20be15f63b1d/rcisignal_sim_briefrc_stimuli.Rdata
#>   (session tempdir).
#> ℹ Wrote base face to
#>   /tmp/RtmpAljdll/rcisignal_sim_20be15f63b1d/rcisignal_sim_briefrc_base_face.png
#>   (session tempdir).
#>   Pass `rdata_dir` to persist across R sessions, or hand `$stimuli` to
#>   downstream consumers.
