...
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■             67% | ETA: 44s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■            69% | ETA: 41s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■            71% | ETA: 38s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■           74% | ETA: 35s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■          76% | ETA: 32s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■          78% | ETA: 29s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■         81% | ETA: 26s
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■        83% | ETA: 23s
...
#> ℹ Wrote stimuli to
#>   /tmp/RtmpYNYLdF/rcisignal_sim_20bb10658566/rcisignal_sim_briefrc_stimuli.Rdata
#>   (session tempdir).
#> ℹ Wrote base face to
#>   /tmp/RtmpYNYLdF/rcisignal_sim_20bb10658566/rcisignal_sim_briefrc_base_face.png
#>   (session tempdir).
...
#> Generating noise pool ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% | ETA:  0s
#> ℹ Wrote stimuli to
#>   /tmp/RtmpYNYLdF/rcisignal_sim_20bb338ebdd5/rcisignal_sim_briefrc_stimuli.Rdata
#>   (session tempdir).
#> ℹ Wrote base face to
#>   /tmp/RtmpYNYLdF/rcisignal_sim_20bb338ebdd5/rcisignal_sim_briefrc_base_face.png
#>   (session tempdir).
#>   Pass `rdata_dir` to persist across R sessions, or hand `$stimuli` to
#>   downstream consumers.
