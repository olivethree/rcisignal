...
- **Manuel Oliveira**. Author, maintainer.
  [](https://orcid.org/0000-0002-6220-0695)

## Citation

Source:
[`DESCRIPTION`](https://github.com/olivethree/rcisignal/blob/v0.1.6/DESCRIPTION)

Oliveira M (2026). *rcisignal: Quality Checks for Reverse-Correlation
Data and Classification Images*. R package version 0.1.6,
